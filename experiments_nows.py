...
THRESHOLD = 220
algorithms = ["BO with scikit", "PSO", "SAMO-COBRA"]
...
def run_grid_search(algorithm_name, grid, scenario):
    ...
    path = f"Results/OptimizationResults/OptimizedPSO/Scenario{scenario}/"
    ...
    for params in param_grid:
        ...
        if algorithm_name == "BO with scikit":
            ...
            result, optimal_lumens, optimal_watts = bo1.start_opt(THRESHOLD, False, scenario, **params)
        ...
        #     start_time = time.time()
        #     result, optimal_lumens, optimal_watts = samo_cobra.start_opt(THRESHOLD, False, scenario, **params)
        #     elapsed = time.time() - start_time
