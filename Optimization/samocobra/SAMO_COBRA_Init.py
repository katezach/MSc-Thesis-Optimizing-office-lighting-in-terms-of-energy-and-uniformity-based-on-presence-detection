...
def SAMO_COBRA_Init(xStart, fn, fName, lower, upper, nConstraints, ref, feval, infillCriteria="PHV",  iterPlot=False, initDesign="HALTON", initDesPoints=None, seqTol=1e-6, epsilonInit=None, epsilonMax=None, newlower=-1, newupper=1, cobraSeed=1):
